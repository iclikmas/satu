...
Name=$(curl -sS https://raw.githubusercontent.com/iclikmas/izin_satu/main/ip | grep $MYIP | awk '{print $2}')
...
rm -rf /root/rmbl
echo -e  "${COLOR1}╭══════════════════════════════════════════╮${NC}"
echo -e  "${COLOR1}│              PASWORD SCRIPT SFVT VPN     │${NC}"
echo -e  "${COLOR1}╰══════════════════════════════════════════╯${NC}"
echo " "
...
madmin=$(curl -sS https://raw.githubusercontent.com/iclikmas/izin_satu/main/ip | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
clear;clear;clear
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│${NC} ${COLBG1}               ${WH} • BOGEL STORE TUNNELING •               ${NC} $COLOR1│ $NC"
echo -e " $COLOR1╰══════════════════════════════════════════════════════════╯${NC}"
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
...
cd
rm -rf *
wget https://raw.githubusercontent.com/iclikmas/satu/main/menu/install-up.sh &> /dev/null
